						...
						<>
							...
							{saveState === "Complete" && (
								...
								>
									{saveStatusCode === 200 ? (
										<>
											Your tune was saved successfully!
											You can now share it with{" "}
											<Link
												to={`/tunes/${tuneId}`}
												target="_blank"
								...
								(failed ? (
									<Alert color="info">
										...
										>
											...
											/>{" "}
											<span>
												Sorry, but this tune wasn't able
												to be repaired.{" "}
												{warnings.length} warnings were
												issued. See something strange?
									...
									<Alert color="info">
										...
										>
											<img
												...
												alt="Orche"
											/>{" "}
											Notation successfully cleaned! No
											fixes were needed.
										</div>
									</Alert>
								))}
...
export default AdvancedComposeForm;
