	...
	return (
		<Container className="mt-5 research-text">
			...
			<p>
				...
				composition and can describe music in text. This research seeks
				to bridge the gap between the nominal understanding of music in
				LLMs and their ability to generate musical scores.
			</p>
			<h3>Objectives</h3>
			<p>
