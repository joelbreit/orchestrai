	...
	return (
		<Container className="mt-5">
			<div className="text-center my-5">
				...
				<p className="lead">
					OrchestrAI is a tool that uses large language models to help
					generate and refine music compositions in ABC notation. This
					notation style allows for legible and editable music that
					can be viewed and played in the browser, shared with others,
					or exported to MIDI.
				</p>
				<Button
					color="primary"
