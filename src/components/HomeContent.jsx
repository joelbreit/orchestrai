	...
	return (
		<Container className="mt-5">
			...
			<div className="text-center my-5">
				...
				<p className="lead">
					OrchestrAI is a tool that uses the power of AI to help
					generate and refine music compositions. It uses large
					language models like GPT-4 to generate music in ABC
